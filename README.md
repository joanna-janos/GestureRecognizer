...
1. Overall results for both tasks
...
<a><img alt="lr finder result plot for pretrained MnasNet" src="results/visualisations_lr_finder/MnasNet/pretrained/the_lowest_point.png"></a>
